...
function renderPicture1(context: CanvasRenderingContext2D, image1: Image, width: number, height: number, time: number) {
  if (time < 0) {
    return;
  }
...
function renderPicture2(context: CanvasRenderingContext2D, image1: Image, width: number, height: number, time: number) {
  if (time < 0) {
    return;
  }
...
function renderPicture3(context: CanvasRenderingContext2D, image1: Image, width: number, height: number, time: number) {
  if (time < 0) {
    return;
  }
